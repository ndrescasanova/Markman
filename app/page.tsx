...
export const metadata: Metadata = {
  ...
  description:
    "Track every trademark you own across USPTO, EUIPO, and WIPO. Watch for conflicts. Search before you file. No lawyer required.",
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Track your entire trademark portfolio across USPTO, EUIPO, and WIPO.
          Get alerted when someone files something similar to your brand.
          Know if a new name is safe to register — before you spend on filings.
        </p>
          ...
          >
            {([
              ...
              },
              {
                ...
                body: "Checking USPTO, EUIPO, and WIPO separately every time you consider a new brand. That's not due diligence — that's busy work.",
              },
              {
                iconColor: "#6B7280",
          ...
          {([
            {
              ...
              description:
                "All your marks, every jurisdiction, one dashboard. Status, renewal dates, and history — automatically synced from USPTO, EUIPO, and WIPO. No more manual checks.",
              detail: "Works across USPTO · EUIPO · WIPO · and more",
              accentColor: "#16A34A",
            },
            {
              number: "02",
              title: "Watch for copycats",
              description:
                "Markman monitors every new trademark filing and alerts you the moment something similar to your brand gets filed. Know before it becomes an expensive problem.",
              detail: "Daily monitoring · Similarity scoring · Instant alerts",
              accentColor: "#D97706",
            },
            {
              number: "03",
              title: "AI conflict search",
              description:
              ...
              detail: "Powered by USPTO + EUIPO data · Not legal advice",
              accentColor: "#2563EB",
            },
            ...
            >
              <div style={{ order: i % 2 === 1 ? 1 : 0 }}>
                ...
                <p style={{ fontSize: 13, color: "#9CA3AF", fontWeight: 400, margin: 0 }}>{feature.detail}</p>
              </div>
                ...
                {i === 1 && (
                  <div style={{ background: "#FAFAFA", border: "1px solid #E5E7EB", borderRadius: 8, padding: 24 }}>
                    ...
                    <div style={{ fontSize: 12, color: "#9CA3AF", marginTop: 12, textAlign: "center" }}>
                      Monitoring 3 marks · Last checked 1h ago
                    </div>
                  </div>
                )}
                {i === 2 && (
                  <div style={{ background: "#FAFAFA", border: "1px solid #E5E7EB", borderRadius: 8, padding: 24 }}>
                    ...
                    <div style={{ fontSize: 11, color: "#9CA3AF", marginTop: 10, textAlign: "center" }}>
                      Not legal advice &mdash; consult an attorney before filing
                    </div>
                  </div>
                )}
              </div>
            ...
            {([
              {
                ...
                body: "Building your third brand and managing trademarks across two countries. Markman keeps it all in one place.",
              },
              {
              ...
              },
              {
                ...
                body: "Operating across the US, EU, and internationally? Track every mark in every jurisdiction from a single dashboard.",
              },
        ...
        >
          ...
          <div style={{ borderTop: "1px solid #E5E7EB", paddingTop: 24, marginBottom: 28 }}>
            {[
              ...
              "USPTO, EUIPO & WIPO tracking",
              "Watch alerts for conflicting new filings",
              "AI conflict search",
              "Team access — CEO, lawyers, anyone",
              "Renewal reminders & deadline tracking",
              ...
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                ...
                <span style={{ fontSize: 14, color: "#0A1628" }}>{item}</span>
              </div>
            ))}
          </div>
